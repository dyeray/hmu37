...
class AssistantWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.search_image = QtGui.QPixmap('dialog-search.png')
        self.search_label = QtWidgets.QLabel()
        self.search_legend = QtWidgets.QLabel(text="¿Qué quieres saber?", parent=self.search_label)
    ...
    def build_right_side(self):
        #self.search_label.setAttribute(Qt.WA_TranslucentBackground, True)
        #search_layout = QtWidgets.QStackedLayout()
